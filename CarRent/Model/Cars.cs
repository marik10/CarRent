...
namespace CarRent.Model
{
    ...
    public partial class Cars
    {
        ...
        public int AvaiabilityId { get; set; }
        public string Plate { get; set; }
        public string VIN { get; set; }
        public int Year4 { get; set; }
        public Nullable<int> PowerKM { get; set; }
    
        public virtual Avaiabilities Avaiabilities { get; set; }
        public virtual Bodies Bodies { get; set; }
